...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], loaded: str = None):
        """b
        ...
        if self.loaded_iter:
            ...
            self.gaussians.load_ply(loaded)
        else:
